...
export default function CourseInfoTwo() {
    return (
        <div className=' px-5 md:px-20 3xl:px-80  overflow-hidden py-20  flex flex-col  gap-6'>
            <h1 className=' text-5xl font-semibold  pb-8'>200 Hours Yoga Teacher Training Course</h1>
            <h1 className='  text-green-800 text-xl font-bold'>Duration: 200 Hours | Course Fee: Shared $500 | Private $650 | Training Style: Multi-Style Yoga TTC</h1>
