...
import CourseInfoFiftyAerial from '../Components/50HoursAerialYoga/CourseInfoFiftyAerial'

function FiFtyHoursAerialYoga() {
  return (
    <>
      <NavComponent imgSrc={ThreeYoga} />
      <CourseInfoFiftyAerial/>
...
export default FiFtyHoursAerialYoga