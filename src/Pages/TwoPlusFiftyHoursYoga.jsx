...
import CourseInfoTwoFifty from '../Components/200+50HoursAerialTraining/CourseInfoTwoFifty'

function TwoPlusFiftyHoursYoga() {
  return (
    <>
...
export default TwoPlusFiftyHoursYoga